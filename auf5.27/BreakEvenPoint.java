...
{ 
    public static void main (String[] args)
   {
      ...
      for(int stueckzahl = 1; stueckzahl <= maxStZahlproMonat; stueckzahl++)
      {
         int gesamtkosten = fixkostenproMonat + (rohstoffkostenProst + arbeitskostenProst) * stueckzahl;

         int erloes = verkaufspreisProst * stueckzahl;
        
         int ueberschuss = erloes - gesamtkosten;

         System.out.println("Stuekzahl: " + stueckzahl + "  Gesamtkosten: " + gesamtkosten + "  Erloes: " + erloes + "  Ueberschuss: " + ueberschuss);
      }
   }
}
